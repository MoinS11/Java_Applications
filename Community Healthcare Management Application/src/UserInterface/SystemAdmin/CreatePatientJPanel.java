...
public class CreatePatientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(addressTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, 221, -1));
        add(nameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 221, -1));
        add(numberTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 221, -1));
        ...
        add(emailTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 310, 221, -1));

        jLabel8.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel8.setText("Age:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 390, 30, 15));

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel2.setText("Patient Name:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 230, 100, -1));

        jLabel9.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel9.setText("Gender:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 430, -1, -1));

        jLabel10.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel10.setText("Blood Group:");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 470, -1, -1));

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel4.setText("Email id:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 60, 20));
        add(ageTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 390, 221, -1));
        add(bloodGroupTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 460, 221, -1));

        jLabel6.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel6.setText("Contact number:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 270, -1, 20));

        genderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "female", "male", "other" }));
        add(genderComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 430, 221, -1));

        jLabel7.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel7.setText("Address:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 350, -1, -1));
        ...
        add(saveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 500, 150, -1));
        add(passwordTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 221, -1));
        add(usernameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 221, -1));

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel3.setText("Password:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 190, -1, 20));

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 0, 13)); // NOI18N
        jLabel5.setText("Username:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 150, -1, 20));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 120, 30));
