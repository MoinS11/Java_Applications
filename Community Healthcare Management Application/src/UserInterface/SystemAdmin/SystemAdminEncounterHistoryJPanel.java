 ...
 * @author moins
 */
public class SystemAdminEncounterHistoryJPanel extends javax.swing.JPanel {
    ...
    public SystemAdminEncounterHistoryJPanel(JPanel WorkArea, Ecosystem business, UserAccount account) {
        initComponents();
